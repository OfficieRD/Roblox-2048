...
function SettingsManager.init(ScreenGui, menuFrame)
	...
	local STitle = Instance.new("TextLabel", SettingsHeader); STitle.Text = "SETTINGS ⚙️"; STitle.Size = UDim2.new(1, 0, 1, 0); STitle.BackgroundTransparency = 1; STitle.TextColor3 = Color3.new(1,1,1); STitle.Font = Enum.Font.FredokaOne; STitle.TextSize = 24; STitle.ZIndex = 1501
